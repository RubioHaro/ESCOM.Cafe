              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.php?id=<?php echo $fila['id']; /*Id del producto*/?>"><img src="images/<?php echo $fila['imagen']; /*Imagen del producto*/?>"
                     alt="<?php echo $fila['nombre']; /*Nombre del producto para el place holder*/?>" class="img-fluid"></a>
                  </figure>
